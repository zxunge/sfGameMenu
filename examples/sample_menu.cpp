...
int main()
{
    ...
    game_menu::Style style{.TitleFont            = &font,
                           .ItemFont             = &font,
                           .TitleFontSize        = 36,
                           .ItemFontSize         = 24,
    ...
    std::vector<game_menu::MenuItem>
        items{{"New Game", [](sf::RenderTarget& target) {}},
    ...
    game_menu::MenuConfig config{.title = "My Game", .items = items, .style = style};
